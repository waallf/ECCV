...
def compute_centroids(label_path,n_anchors,loss_convergence,grid_size,iterations_num,plus):
    ...
    boxes = []
    label_files = []
    image_names = sorted(os.listdir(label_path))
#

    for label_file in image_names:
    ...
    for i in groups:
        print(len(i)/float(len(boxes)))
        # print(centroid.w * grid_size, centroid.h * grid_size)


label_path = '/home/z840/Desktop/ECCV-task1/VisDrone2018-DET-val/annotations/'
n_anchors = 8
