...
tf.app.flags.DEFINE_bool(
    'DSSD_FLAG', False, 'Train SSD or DSSD')  #SSD_15760开始训练DSSD
...
# =========================================================================== #
tf.app.flags.DEFINE_string(
    'dataset_name', 'eccv', 'The name of the dataset to load.')
tf.app.flags.DEFINE_integer(
    'num_classes', 11, 'Number of classes to use in the dataset.')
tf.app.flags.DEFINE_string(
    'dataset_split_name', 'train', 'The name of the train/test split.')
tf.app.flags.DEFINE_string(
    'dataset_dir', './tf_record', 'The directory where the dataset files are stored.')
tf.app.flags.DEFINE_integer(
    'labels_offset', 0,
